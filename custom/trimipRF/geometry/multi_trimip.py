...
class MultiTriMipRFModel(BaseImplicitGeometry):
    @dataclass
    ...
    def create_from(
        ...
        **kwargs,
        ...
        if isinstance(other, MultiTriMipRFModel):
            instance = MultiTriMipRFModel(cfg, **kwargs)
            ...
            raise TypeError(
                f"Cannot create {MultiTriMipRFModel.__name__} from {other.__class__.__name__}"
            )
