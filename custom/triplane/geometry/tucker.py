...
from .utils import contract_to_unisphere_triplane, get_tucker
@threestudio.register("triplane-tucker")
class TriplaneTucker(BaseImplicitGeometry):
    @dataclass
    ...
    def create_from(
        ...
        **kwargs,
        ...
        if isinstance(other, TriplaneTucker):
            instance = TriplaneTucker(cfg, **kwargs)
            ...
            raise TypeError(
                f"Cannot create {TriplaneTucker.__name__} from {other.__class__.__name__}"
            )
