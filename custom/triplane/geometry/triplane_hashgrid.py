...
from .utils import contract_to_unisphere_triplane, get_kplane_hashgrid

@threestudio.register("triplane_hashgrid")
class TriplaneHashGrid(BaseImplicitGeometry):
    @dataclass
    ...
    def configure(self) -> None:
        super().configure()
        self.encoding = get_kplane_hashgrid(
    ...
    def create_from(
        ...
        **kwargs,
        ...
        if isinstance(other, TriplaneHashGrid):
            instance = TriplaneHashGrid(cfg, **kwargs)
            ...
            raise TypeError(
                f"Cannot create {TriplaneHashGrid.__name__} from {other.__class__.__name__}"
            )
