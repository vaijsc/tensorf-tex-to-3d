...
from .utils import contract_to_unisphere_triplane, get_kplane_interp

@threestudio.register("triplane_interp")
class TriplaneInterpolate(BaseImplicitGeometry):
    @dataclass
    ...
    def configure(self) -> None:
        super().configure()
        self.encoding = get_kplane_interp(
    ...
    def create_from(
        ...
        **kwargs,
        ...
        if isinstance(other, TriplaneInterpolate):
            instance = TriplaneInterpolate(cfg, **kwargs)
            ...
            raise TypeError(
                f"Cannot create {TriplaneInterpolate.__name__} from {other.__class__.__name__}"
            )
