...
from .utils import contract_to_unisphere_triplane, get_kplane

@threestudio.register("triplane")
class Triplane(BaseImplicitGeometry):
    @dataclass
    ...
    def create_from(
        ...
        **kwargs,
        ...
        if isinstance(other, Triplane):
            instance = Triplane(cfg, **kwargs)
            ...
            raise TypeError(
                f"Cannot create {Triplane.__name__} from {other.__class__.__name__}"
            )
